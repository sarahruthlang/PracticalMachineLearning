...
```{r}
training_data <- read.csv("C:/Users/sarahruthlang/Documents/R/PML/pml-training.csv", na.strings=c("#DIV/0!") )
evaluation_data <- read.csv("C:/Users/sarahruthlang/Documents/R/PML/pml-testing.csv", na.strings=c("#DIV/0!") )
```
...
```
```{r}
setwd("C:/Users/sarahruthlang/Documents/R/PML/")
